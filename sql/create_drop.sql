...
CREATE TABLE Contact (
    ...
    email VARCHAR(99),
    address VARCHAR(99),
    CONSTRAINT fk_address FOREIGN KEY(address) REFERENCES RealWorldAddress(code)
);
...
CREATE TABLE ServiceTime (
    ...
    location VARCHAR(99) NOT NULL DEFAULT 'st-mary-magdalene',
...
CREATE TABLE ParishRole (
    ...
    CONSTRAINT fk_contact FOREIGN KEY(contact) REFERENCES Contact(code)
);
...
CREATE TABLE Newsletter (
    ...
    link VARCHAR(99) NOT NULL DEFAULT
